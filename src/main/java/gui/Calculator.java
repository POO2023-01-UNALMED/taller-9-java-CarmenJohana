...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		...
		char[] chars=displayText.getText().toCharArray();
		...
		try {
			...
			for (char ch: chars) {
				...
				else if(operator!=null && !(operator.equals(String.valueOf(ch)))) {
					number2+=ch;
				}
			...
			if(cantidadOperadores>1) {
			...
			else if(cantidadOperadores==0 && number1!="") {
				...
				displayText.setText(String.valueOf(number1));
			}
